...
export const examYears = pgTable("exam_years", {
  ...
  certificateFee: decimal("certificate_fee", { precision: 10, scale: 2 }).default('50.00'),
  transcriptFee: decimal("transcript_fee", { precision: 10, scale: 2 }).default('25.00'),
...
export const students = pgTable("students", {
  ...
  middleNameEn: varchar("middle_name_en", { length: 255 }),
  nationality: varchar("nationality", { length: 255 }),
  nationalityEn: varchar("nationality_en", { length: 255 }),
