...
- **Center Hall Management**: Exam centers can have named halls/rooms with capacity. Admins manage halls via a dedicated tab in the center dashboard. Halls are optionally assigned to exam packets and attendance scans. The packet tracking table displays hall assignment. The mobile attendance scanner shows a hall selector when halls are configured for the center.
