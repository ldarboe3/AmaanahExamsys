      ...
      <section className="relative min-h-[88vh] flex items-center overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 py-20 md:py-32">
          <div className="max-w-3xl animate-fade-in">
            {/* Gold badge pill */}
            <div className="inline-flex items-center gap-2 px-4 py-2 mb-7 rounded-full bg-amber-400/15 border border-amber-400/30 backdrop-blur-sm" data-testid="badge-hero">
            ...
            <h1
              className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-white mb-6 leading-[1.05] tracking-tight"
              data-testid="heading-hero"
            >
              {isRTL ? (
                <span className="text-amber-400">التعليم من أجل التنمية</span>
              ) : (
                <>
                  Education for
                  <br />
            ...
            <div className="mt-12 flex flex-wrap gap-6">
              {[
                { value: "400+", label: isRTL ? "مدارس" : "Schools" },
                { value: "50K+", label: isRTL ? "طلاب معتمدون" : "Students Certified" },
                { value: "7", label: isRTL ? "مناطق" : "Regions" },
      ...
      <section className="py-14 md:py-20 bg-[#0d3320] relative overflow-hidden">
        ...
        <div className="relative container mx-auto px-4">
          <div className="text-center mb-14">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-4 rounded-full border border-amber-400/30 bg-amber-400/10">
              <span className="text-amber-400 text-sm font-semibold tracking-wide">{isRTL ? "تأثيرنا" : "Our Impact"}</span>
            </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {impactStats.map((stat, i) => (
              <div key={stat.label} className="text-center group" data-testid={`stat-${i}`}>
                <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-amber-400/10 border border-amber-400/20 flex items-center justify-center mx-auto mb-5 transition-all duration-300 group-hover:bg-amber-400/20 group-hover:scale-110">
                  <stat.icon className="w-8 h-8 md:w-10 md:h-10 text-amber-400" />
                </div>
                <p className="text-4xl md:text-5xl font-extrabold text-amber-400 mb-2">{stat.value}</p>
                <p className="text-white/60 font-medium text-sm">{isRTL ? stat.labelAr : stat.label}</p>
              </div>
            ))}
          </div>
        </div>
